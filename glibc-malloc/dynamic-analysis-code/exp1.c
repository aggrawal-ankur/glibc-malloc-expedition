...
/* METHOD:
  ...
  Step1: Allocate three chunks: the last chunk borders with the top, the first chunk stays as a barrier from the front and the middle chunk is freed. The size of the middle chunk is 10 bytes, which after alignment becomes 32 bytes.
